...
void R_TAU0_Channel0_Start(void)
{
    ...
    TOE0 |= _0002_TAU_CH1_OUTPUT_ENABLE | _0004_TAU_CH2_OUTPUT_ENABLE | _0008_TAU_CH3_OUTPUT_ENABLE |
            _0010_TAU_CH4_OUTPUT_ENABLE | _0020_TAU_CH5_OUTPUT_ENABLE;
