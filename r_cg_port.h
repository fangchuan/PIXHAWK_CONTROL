...
#define CAMERA_CONTROL P1.5
#define RELAY_CONTROL  P1.0

#define LED1_ON    (P13.0 =1)
#define LED1_OFF   (P13.0 =0)
#define LED1_TOGGLE (P13.0 = ~P13.0)
#define LED2_OFF    (P5.3 =0)
#define LED2_ON   (P5.3 =1)
#define LED2_TOGGLE (P5.3 = ~P5.3)
#define BEEP_ON    (P5.2 =1)
#define BEEP_OFF   (P5.2 =0)
#define BEEP_TOGGLE (P5.2 = ~P5.2)
